...
intro_message = 'Hey guys! I am your friend Joey and i am designed to make your day better. Here are somethings I can do ...'
...
async def on_message(message):
    ...
    # greet our bot
        ...
        if len(online_members) == 0:
            ...
            await channel.send('These folks are online: ', ', '.join(online_members) + "\nAnd of course there is me for you, forever!")
    ...
    # get dad_joke from api file and reply based on the feedback given
        ...
        try:
            ...
            if reply.content == '1':
                await channel.send(f"I'll get better, thanks for responding {reply.author.name}")
    ...
    # get yo_momma_joke
    elif msg.startswith(f'{mention} yo momma') or msg.startswith('ami yo momma') or msg.startswith(f'{mention}yo momma') or (msg.startswith('yo momma') and (client.user in mentions)):
